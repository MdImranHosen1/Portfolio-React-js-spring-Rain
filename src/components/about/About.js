    ...
    <div id="about" className="about-main-div">
      ...
      <div className="flex-container-about">
        <article>
          ...
          <div id="about_more_div"  className="hidden"><br />
            <p>
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nulla
              excepturi nesciunt eligendi deleniti vero voluptatibus consequatur
              ad quaerat officiis eos facilis, libero, incidunt nobis fuga
          ...
          <div Style="margin-top:10px; display: flex ; justify-content: center;">
            <img id="about_more_button_img" Style=" cursor: pointer; opacity: 80%;" onclick="handleClickAboutMore()"  width="30px" src={viewmore} alt=''/>
          </div>
        </article>
        <figure>
          <img src={myself} alt='' />
